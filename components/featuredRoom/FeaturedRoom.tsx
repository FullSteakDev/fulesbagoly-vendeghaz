...
import { Vendeghaz } from '../../models/vendeghaz';

type Props = {
  featuredRoom: Vendeghaz;
};
...
const FeaturedRoom: FC<Props> = props => {
  ...
  return (
    <section className='flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto'>
      ...
      <div className='md:py-10 md:w-4/2 text-left'>
        <h3 className='font-heading mb-12'>Fülesbagoly Vendégház</h3>
        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between mt-5'>
          <div className='flex mb-3 md:mb-0'>
            <div className='flex gap-3 flex-col items-center justify-center mr-4'>
              <p className='text-xs lg:text-xl text-center'>Ház / éjszaka</p>
          ...
          <Link
            href={`/vendeghaz/${featuredRoom.slug.current}`}
