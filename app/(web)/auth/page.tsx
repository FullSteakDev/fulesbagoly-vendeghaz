...
const Auth = () => {
    ...
    const loginHandler = async () => {
        try {
            ...
            console.log(error);
            toast.error("Valami rosszul sült el");
        }
    };
    ...
    const handleSubmit = async (event: FormEvent <HTMLFormElement>) => {
        ...
        try {
            ...
            if (user) {
                toast.success("Siker, kérlek jelentkezz be")
            }
        } catch (error) {
            console.log(error);
            toast.error("Valami rosszul sült el")
        ...
        <section className="container mx-auto">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] mx-auto">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button onClick={loginHandler} className='text-tertiary-dark underline'>Bejelentkezés</button>
                </form>
            </div>
        </section>
    );
