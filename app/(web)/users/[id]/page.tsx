...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  >('bookings');
  const [vendeghazId, setVendeghazId] = useState<string | null>(null);
  ...
  const reviewSubmitHandler = async () => {
    ...
    if (!vendeghazId) toast.error('Id not provided');
    ...
    try {
      ...
      console.log(data);
      toast.success('Értékelés elküldve, köszönjük');
    } catch (error) {
      console.log(error);
      toast.error('Sikertelen értékelés');
    } finally {
      setRatingText('');
      setRatingValue(null);
      setVendeghazId(null);
      ...
      <div className='grid md:grid-cols-12 gap-10'>
        <div className='hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-[#eff0f2] text-black rounded-lg px-6 py-4'>
          ...
          <div className='font-normal py-4 text-left'>
            <h6 className='text-xl font-bold pb-3'>Rólam</h6>
          ...
          <div className='flex items-center'>
            <p className='mr-2'>Kijelentkezés</p>
            <FaSignOutAlt
        ...
        <div className='md:col-span-8 lg:col-span-9'>
          <div className='flex items-center'>
            <h5 className='text-2xl font-bold mr-3'>Szia, {userData.name}</h5>
          </div>
          ...
          <p className='text-xs py-2 font-medium'>
            Csatlakozott {userData._createdAt.split('T')[0]}
          </p>
